...
%}
function [PL, PLI, ES] = P_TrainInterval_MultiCh_FixInterval(filepath, varargin)
...
RepsPerCh_test = 100; % How many times the the stim pulse will be repeated
                 % on each channel during testing. (A A A ... B B B ...)
                 
RepsPerCh_train = 100; % How many times the stim pulse will be repeated on
