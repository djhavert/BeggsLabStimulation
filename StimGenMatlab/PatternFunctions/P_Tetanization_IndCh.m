...
%}
function [PL, PLI, ES] = P_Tetanization_IndCh(saveLocation, nameFileLib, varargin)
...
for i=1:length(Channels)
    for j=1:Trains
        PulseTimes(pulsecount:(pulsecount+RepsPerCh-1)) = (0:TetanicInterval:(TetanicInterval*RepsPerCh-1)) + PulseTimes(pulsecount);
        PulseTimes(pulsecount+RepsPerCh) = PulseTimes(pulsecount) + InterPulseDelay;
