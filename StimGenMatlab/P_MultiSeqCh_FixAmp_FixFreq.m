%{
[PL, PLI, ES] = P_MultiSeqCh_FixAmp_FixFreq(saveLocation, nameFileLib, varargin)
...
%}
function [PL, PLI, ES] = P_MultiSeqCh_FixAmp_FixFreq(saveLocation, nameFileLib, varargin)
